...
import ScriptEditor from "@/components/user-dashboard/project-details/breakdown-more/script/ScriptEditor";
...
const Script = () => {
  ...
  const [isScriptUploaded, setIsScriptUploaded] = useState(true);
  return (
    <div className=" w-full" style={{ height: "calc(100vh - 70px)" }}>
      {isScriptUploaded ? (
        ...
        <section className=" p-4">
          ...
          <div className=" flex justify-center items-center mt-36 gap-6">
            <Button

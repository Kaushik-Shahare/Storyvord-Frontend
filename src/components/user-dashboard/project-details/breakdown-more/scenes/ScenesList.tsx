    ...
    <div className="pt-6">
      <div className="w-full">
        ...
        {scenes.map((scene) => (
          <div
            key={scene.id}
            className="grid grid-cols-[50px_2fr_1fr_1fr_1fr_1fr] bg-white hover:bg-gray-50 transition-shadow mt-6 py-5 shadow-sm rounded-lg border-l-8 border-sky-300 items-center"
          >
            <div className="p-4">
              <Checkbox
